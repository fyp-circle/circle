...
class ImageController extends Controller
{
    public function UploadUserProfilePicture(Request $request){
        ...
        $request->image->move(public_path('images/users/Profile_Pictures'), $imageName);
        $user = User::find(Auth::user()->user_id);
        $user->profile_picture = 'images/users/Profile_Pictures/'.$imageName;
        $user->save();
    ...
    public function UploadUserCoverPicture(Request $request){
        ...
        $user = User::find(Auth::user()->user_id);
        $user->cover_picture = 'images/users/Cover_Pictures/'.$imageName;
        $user->save();

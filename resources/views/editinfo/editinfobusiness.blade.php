                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="basic">
                                    <ul class="basics">
                                        <form method="post" action="{{ route('editinfobusinesspost',['id'=>Auth::user()->user_id,'circle_id'=>3]) }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <input type="text" id="input" required="required" name="name" value= "{{Auth::user()->business_user['name']}}"  />
                                                <label class="control-label" for="input">Full Name</label><i
                                                    class="mtrl-select"></i>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required="required" name="email" value= "{{Auth::user()->business_user['email']}}"/>
                                                <label class="control-label" for="input">Email@</label><i
                                                    class="mtrl-select"></i>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required="required"  name="phone" value= "{{Auth::user()->business_user['phone']}}" />
                                                <label class="control-label" for="input">Phone No.</label><i
                                                    class="mtrl-select"></i>
                                            </div>
                                            <div class="form-group">
                                                <textarea rows="4" id="textarea" required="required" name="about_me">{{Auth::user()->business_user['about_me']}}</textarea>
                                ...
                                <div class="tab-pane fade" id="interest" role="tabpanel">
                                    <div class="editing-interest">
                                        <form method="post">
                                            ...
                                            <div><input type="text" placeholder="Communication, Programming, C...">
                                            <button type="submit">Add</button></div>
                                            <ol class="interest-added">
                                                <li><a href="#" title="">Java</a><span class="remove"
                                                        title="remove"><i class="fa fa-close"></i></span></li>
                                                <li><a href="#" title="">Python</a><span class="remove"
                                                        title="remove"><i class="fa fa-close"></i></span></li>
                                                <li><a href="#" title="">UI/UX Design</a><span class="remove"
                                                        title="remove"><i class="fa fa-close"></i></span></li>
                                                <li><a href="#" title="">Good Communication</a><span class="remove"
                                                        title="remove"><i class="fa fa-close"></i></span></li>
                                                <li><a href="#" title="">Leadership</a><span class="remove"
                                                        title="remove"><i class="fa fa-close"></i></span></li>
                                                <li><a href="#" title="">Data Science</a><span class="remove"
                                                        title="remove"><i class="fa fa-close"></i></span></li>
                                            </ol>
                                            <div class="submit-btns">
                                                <button type="button" class="mtr-btn"><span>Cancel</span></button>

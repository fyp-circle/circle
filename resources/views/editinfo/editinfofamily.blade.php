                                ...
                                <div class="tab-pane fade show active" id="basic">
                                    <ul class="basics">
                                        <form method="post" action="{{ route('editinfofamilypost',['id'=>Auth::user()->user_id,'circle_id'=>2]) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="required" name="email" value= "{{Auth::user()->family_user['email']}}"/>
                                                <label class="control-label" for="input">Email@</label><i
                                                    class="mtrl-select"></i>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required="required"  name="phone" value= "{{Auth::user()->family_user['phone']}}" />
                                                <label class="control-label" for="input">Phone No.</label><i
                                                    class="mtrl-select"></i>
                                            </div>
                                            <div class="form-group">
                                                <textarea rows="4" id="textarea" required="required" name="about_me">{{Auth::user()->family_user['about_me']}}</textarea>

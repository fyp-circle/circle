                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="login-reg-bg">
                        ...
                        <div class="log-reg-area reg">
                            <h2 class="log-title">Verify Code</h2>
                            <p>
                                Enter Code here!
                            </p>
                            <form method="post">
                                <div class="form-group">
                                    ...
                                    <label class="control-label" for="input">C-Code</label><i class="mtrl-select"></i>
                                </div>
                                <div class="submit-btns">
                                    <button class="mtr-btn signup" type="button"><span>Verify</span></button>
                                </div>
                            </form>
                        </div>
                    </div>

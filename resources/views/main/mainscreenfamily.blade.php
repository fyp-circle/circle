            ...
            <li>
                <div class="author-thmb" style="width: 66%">
                    ...
                    <a href="{{ route('message',['id'=>$con->user1_id,'circle_id'=>$circle_id]) }}" title=""><img
                            src="{{$con->user1->family_user->profile_picture}}" alt=""></a>
                    @else
                    <a href="{{ route('message',['id'=>$con->user2_id,'circle_id'=>$circle_id]) }}" title=""><img
                            src="{{$con->user2->family_user->profile_picture}}" alt=""></a>
                    @endif
...
<div class="fixed-sidebar left">
    <div class="menu-left">
        <ul class="left-menu">
            ...
            <li><a href="{{ route('main.settings',['circle_id'=>2]) }}" title="Main Setting" data-toggle="tooltip"
                    data-placement="right"><i class="fas fa-cogs" style="-webkit-text-fill-color: red"></i></a></li>
            <li><a href="{{ route('viewfamily',['id'=>Auth::user()->user_id,'circle_id'=>$circle_id]) }}" title="Family"
                    data-toggle="tooltip" data-placement="right"><i class="fas fa-users"
                        style="-webkit-text-fill-color: red"></i></a>
        </ul>
    </div>
                        ...
                        <div class="col-lg-3">
                            <aside class="sidebar static">
                                ...
                                <div class="widget stick-widget">
                                    <h4 class="widget-title">Family Requests</h4>
                                    @if (count($reqs)==0)
                                    <ul class="followers">
                                        <li>
                                            <div class="friend-meta">
                                                <h4><a href="" title="">No Family Request</a></h4>
                                            </div>
                                        </li>
                                    </ul>
                                    @else
                                    <ul class="followers">
                                        ...
                                        <li>
                                            ...
                                            <a href="{{ route('viewprofilefamily',['id'=>$req->user1->user_id,'circle_id'=>$circle_id]) }}"
                                                title="">
                                                <figure><img src="{{$req->user1->family_user->profile_picture}}" alt="">
                                                </figure>
                                            </a>
                                            @else
                                            <a href="{{ route('viewprofilefamily',['id'=>$req->user1->user_id,'circle_id'=>$circle_id]) }}"
                                                title="">
                                                <figure><img src="{{$req->user2->family_user->profile_picture}}" alt="">
                                                </figure>
                                            </a>
                                            @endif
                                            <div class="friend-meta">
                                                @if ($req->user1_id!=Auth::user()->user_id)
                                                <h4><a href="{{ route('viewprofilefamily',['id'=>$req->user1->user_id,'circle_id'=>$circle_id]) }}"
                                                        title="">{{$req->user1->family_user->name}}</a></h4>
                                                @else
                                                <h4><a href="{{ route('viewprofilefamily',['id'=>$req->user2->user_id,'circle_id'=>$circle_id]) }}"
                                                        title="">{{$req->user2->family_user->name}}</a></h4>
                                                @endif
                        ...
                        <div class="col-lg-6">
                            <div class="central-meta new-pst">
                                <div class="new-postbox">
                                    <figure>
                                        <img src="{{Auth::user()->family_user['profile_picture']}}" alt=""
                                ...
                                <div class="central-meta item">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                <a
                                                    href="{{ route('viewprofilefamily',['id'=>$post->user->user_id,'circle_id'=>$circle_id]) }}"><img
                                                        src="{{$post->user->family_user->profile_picture}}" alt=""></a>
                                            </figure>
                                            <div class="friend-name">
                                                <ins><a href="{{ route('viewprofilefamily',['id'=>$post->user->user_id,'circle_id'=>$circle_id]) }}"
                                                        title="">{{$post->user->family_user->name}}</a></ins>
                        ...
                        <div class="friend-info">
                            ...
                            <div class="post-meta">
                                <div class="linked-image align-left">
                                    <a title="" href="#"><img alt="" src="/images/resources/post2.jpg"></a>
                                </div>
                                <div class="detail">

                                ...
                                <div class="widget stick-widget">
                                    ...
                                    <ul class="followers">
                                        ...
                                        <li>
                                            ...
                                            <a href="{{ route('viewprofilefamily',['id'=>$req->user1->user_id,'circle_id'=>$circle_id]) }}" title=""><figure><img src="{{$req->user1->family_user->profile_picture}}" alt=""></figure></a>
                                            @else
                                            <a href="{{ route('viewprofilefamily',['id'=>$req->user1->user_id,'circle_id'=>$circle_id]) }}" title=""><figure><img src="{{$req->user2->family_user->profile_picture}}" alt=""></figure></a>
                                            @endif
                                            <div class="friend-meta">
                                                @if ($req->user1_id!=Auth::user()->user_id)
                                                <h4><a href="{{ route('viewprofilefamily',['id'=>$req->user1->user_id,'circle_id'=>$circle_id]) }}" title="">{{$req->user1->family_user->name}}</a></h4>
                                                @else
                                                <h4><a href="{{ route('viewprofilefamily',['id'=>$req->user2->user_id,'circle_id'=>$circle_id]) }}" title="">{{$req->user2->family_user->name}}</a></h4>
                                                @endif

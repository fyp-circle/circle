...
<div class="fixed-sidebar left">
    <div class="menu-left">
        <ul class="left-menu">
            ...
            <li><a href="{{ route('editinfobusiness',['id'=>Auth::user()->user_id,'circle_id'=>$circle_id]) }}"
                                                ...
                                                <div class="description">
                                                    ...
                                                    <p>
                                                        World's most beautiful car in Curabitur <a href="#"
                                                            title="">#test drive
                                                            booking !</a> the most beatuiful car available in america
                                                        and the saudia
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="we-comment">
                                                                ...
                                                                <p>i like lexus cars, lexus cars are most beautiful with
                                                                    the awesome
                                                                    features, but this car is really outstanding than
                                                                    lexus</p>
                                                            </div>
                                                        </li>
                                                    </ul>

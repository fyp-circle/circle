                                ...
                                <div class="central-meta item">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                <a
                                                    href="{{ route('viewprofilebusiness',['id'=>$post->user->user_id,'circle_id'=>$circle_id]) }}"><img
                                                        src="{{$post->user->business_user->profile_picture}}"
                                                        alt=""></a>
                                            </figure>
                                            <div class="friend-name">
                                                <ins><a href="{{ route('viewprofilebusiness',['id'=>$post->user->user_id,'circle_id'=>$circle_id]) }}"
                                                        title="">{{$post->user->business_user->name}}</a></ins>
                        ...
                        <div class="your-page">
                            ...
                            <div class="page-likes">
                                <ul class="nav nav-tabs likes-btn">
                                    <li class="nav-item"><a class="active" href="#link1" data-toggle="tab">likes</a>
                                    </li>

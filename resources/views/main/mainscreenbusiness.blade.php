...
<div class="fixed-sidebar left">
    <div class="menu-left">
        <ul class="left-menu">
            <li><a href="{{ route('mainscreenbusiness',['circle_id'=>$circle_id]) }}" title="Newsfeed Page" data-toggle="tooltip" data-placement="right"><i
                        class="ti-magnet" style="-webkit-text-fill-color:cornflowerblue "></i></a></li>
            ...
            <li><a href="{{ route('viewbusiness',['id'=>Auth::user()->user_id,'circle_id'=>$circle_id]) }}" title="
                    Friends" data-toggle="tooltip" data-placement="right"><i class="ti-themify-favicon" style="-webkit-text-fill-color:cornflowerblue "></i></a></li>
        </ul>
    </div>
                                ...
                                <div class="widget">
                                    ...
                                    <ul class="naves">
                                        <li>
                                            ...
                                            <a href="{{ route('mainscreenbusiness',['circle_id'=>$circle_id]) }}" title="">News feed</a>
                                        </li>
                                        <li>
                                            <i class="ti-user"></i>

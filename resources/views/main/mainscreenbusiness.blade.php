            ...
            <li>
                <div class="author-thmb" style="width: 66%">
                    ...
                    <a href="{{ route('message',['id'=>$con->user1_id,'circle_id'=>$circle_id]) }}" title=""><img
                            src="{{$con->user1->business_user->profile_picture}}" alt=""></a>
                    @else
                    <a href="{{ route('message',['id'=>$con->user2_id,'circle_id'=>$circle_id]) }}" title=""><img
                            src="{{$con->user2->business_user->profile_picture}}" alt=""></a>
                    @endif
    ...
    <div class="menu-left">
        <ul class="left-menu">
            ...
            <li><a href="{{ route('messagebusiness',['circle_id'=>$circle_id]) }}" title="Inbox" data-toggle="tooltip"
                    data-placement="right"><i class="fas fa-envelope"
                        style="-webkit-text-fill-color:cornflowerblue"></i></a></li>
            <li><a href="{{ route('viewbusiness',['id'=>Auth::user()->user_id,'circle_id'=>$circle_id]) }}"
                    title="View Connections" data-toggle="tooltip" data-placement="right"><i class="fas fa-users"
            ...
            <li><a href="{{ route('viewprofilebusiness',['id'=>Auth::user()->user_id,'circle_id'=>$circle_id]) }}"
                    title="View Profile" data-toggle="tooltip" data-placement="right"><i class="fas fa-user"
                        style="-webkit-text-fill-color:cornflowerblue"></i></a>
            </li>
            <li><a href="{{ route('nearbyconnections',['circle_id'=>$circle_id]) }}" title="Nearby Connections"
                    data-toggle="tooltip" data-placement="right"><i class="fas fa-street-view"
                        style="-webkit-text-fill-color:cornflowerblue"></i></a>
            </li>
            <li><a href="{{ route('activitybusiness',['circle_id'=>$circle_id]) }}" title="Insights"
                    data-toggle="tooltip" data-placement="right"><i class="fas fa-chart-line"
                        style="-webkit-text-fill-color:cornflowerblue"></i></a></li>
            <li><a href="{{ route('editinfobusiness',['circle_id'=>$circle_id]) }}" title="Edit Profile Info"
                    data-toggle="tooltip" data-placement="right"><i class="fas fa-user-edit"
                        style="-webkit-text-fill-color:cornflowerblue"></i></a></li>
                                ...
                                <div class="widget stick-widget">
                                    ...
                                    <ul class="followers">
                                        <li>
                                            <div class="friend-meta">
                                                <h4><a href="" title="">No Connection Request</a></h4>
                                            </div>
                                        </li>
                                    </ul>
                                    @else
                                    <ul class="followers">
                                        ...
                                        <li>
                                            ...
                                            <a href="{{ route('viewprofilebusiness',['id'=>$req->user1->user_id,'circle_id'=>$circle_id]) }}"
                                                title="">
                                                <figure><img src="{{$req->user1->business_user->profile_picture}}"
                                                        alt=""></figure>
                                            </a>
                                            @else
                                            <a href="{{ route('viewprofilebusiness',['id'=>$req->user1->user_id,'circle_id'=>$circle_id]) }}"
                                                title="">
                                                <figure><img src="{{$req->user2->business_user->profile_picture}}"
                                                        alt=""></figure>
                                            </a>
                                            @endif
                                            <div class="friend-meta">
                                                @if ($req->user1_id!=Auth::user()->user_id)
                                                <h4><a href="{{ route('viewprofilebusiness',['id'=>$req->user1->user_id,'circle_id'=>$circle_id]) }}"
                                                        title="">{{$req->user1->business_user->name}}</a></h4>
                                                @else
                                                <h4><a href="{{ route('viewprofilebusiness',['id'=>$req->user2->user_id,'circle_id'=>$circle_id]) }}"
                                                        title="">{{$req->user2->business_user->name}}</a></h4>
                                                @endif
                        ...
                        <div class="col-lg-6">
                            <div class="central-meta new-pst">
                                <div class="new-postbox">
                                    <figure>
                                        <img src="{{Auth::user()->business_user['profile_picture']}}" alt=""
